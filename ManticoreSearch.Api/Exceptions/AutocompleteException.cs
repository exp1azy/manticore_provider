...
{
    /// <summary>
    /// Represents errors that occur during autocomplete operations in Manticore.
    /// </summary>
    public class AutocompleteException : Exception
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AutocompleteException"/> class.
        /// </summary>
        ...
        public AutocompleteException(string message, Exception innerException)
